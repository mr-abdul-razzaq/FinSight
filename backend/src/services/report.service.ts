...
export const generateReportService = async (
  ...
  if (subscription) {
    if (subscription.plan === "FREE" && subscription.usageCount.aiReports >= 1) {
      throw new BadRequestException("You have reached the limit of 1 AI report for the FREE plan. Please upgrade to PRO.");
    }
    if (subscription.plan === "PRO" && subscription.usageCount.aiReports >= 10) {
      throw new BadRequestException("You have reached the limit of 10 AI reports for the PRO plan. Please upgrade to BUSINESS.");
    }
  }
  ...
  if (subscription) {
    subscription.usageCount.aiReports += 1;
